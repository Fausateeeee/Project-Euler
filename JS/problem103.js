...
/*
    ...
    the next optimum set is of the form B = {b, a1+b, a2+b, ... ,an+b}, where b is the "middle" element on the previous row.
...
rl.question('Press enter to continue : ', (answer) => {
    ...
    console.log("The string for the optimum special sum set for n = 7 is", "ANSWER");
    rl.close();
});
